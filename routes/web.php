...
Route::middleware((['auth', 'customer']))->group(function (){
    ...
    Route::post('/profile', [LandingController::class, 'profileUpdate'])->name('update.profile');
    Route::post('/profile/password', [LandingController::class, 'updatePassword'])->name('update.password');
    Route::get('/myorder', [LandingController::class, 'order'])->name('yourorder.index');
    Route::post('/myorder', [LandingController::class, 'orderStore'])->name('yourorder.update');
    Route::patch('/myorder/{id}', [LandingController::class, 'orderCancel'])->name('yourorder.cancel');
