...
<aside
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ request()->is('report') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ request()->is('complements*') ? 'active' : '' }}"
                    href="{{ route('complements.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ request()->is('landing-settings') ? 'active' : '' }}"
                    href="{{ route('landing-settings.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">settings</i>
                    </div>
                    <span class="nav-link-text ms-1">Landing Setting</span>
                </a>
            </li>
        </ul>
    </div>
