    ...
    <div class="contains m-auto">
        <header class="header-v2 fixed-top m-auto">
            <div class="wrap-header-mobile">
                ...
                @if(request()->is('checking*','checkout*'))
    ...
    <div class="nav-bottom fixed-bottom bg-white m-auto text-center">
        <div class="row">
            ...
            <div class="nav-bottom-item col-3">
                ...
                @else
                <a href="{{ route('landing.home') }}#product-section" class="{{ request()->routeIs('customer.membership') || request()->is('history') ? 'active' : 'text-dark'}}">
