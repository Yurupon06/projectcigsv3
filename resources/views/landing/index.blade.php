    ...
    <header class="header-v2">
            ...
            <div class="wrap-menu-desktop">
                <nav class="limiter-menu-desktop p-l-45">
                    ...
                    <div class="wrap-icon-header flex-w flex-r-m h-full">
                        ...
                        @else
                            <form onsubmit="return confirm('Apakah anda yakin ingin logout?')"
        ...
        <div class="menu-mobile">
            <ul class="main-menu-m">
				...
				<form onsubmit="return confirm('Apakah anda yakin ingin logout?')" id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
					@csrf
				</form>
				@endauth
