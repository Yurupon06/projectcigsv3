                        ...
                        <div class="p-r-50 p-t-5 p-lr-0-lg ms-2">
                            ...
                            <div class="d-flex align-items-center justify-content-end pt-2">
                                <form action="{{ route('cart.add', $complement->id) }}" method="POST">
                                    ...
                                    <input class="mtext-104 cl3 txt-center" type="number" name="quantity" id="quantity" value="1" min="1" max="{{ $complement->stok }}">
                            ...
                            <div class="total-price">Total: Rp. <span id="total-price"></span></div>
