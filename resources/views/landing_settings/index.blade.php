                        ...
                        @if ($landingSetting)
                            <form action="{{ route('landing-settings.update', $landingSetting->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="color" class="form-control @error('banner_p_color') is-invalid @enderror" id="banner_p_color" name="banner_p_color" value="{{ old('banner_p_color', $landingSetting->banner_p_color) }}">
