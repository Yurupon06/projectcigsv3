                ...
                <div class="card border-1 m-3 pt-3">
                  <form action="{{ route('user.update', $user->id) }}" method="POST">
                      ...
                      <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="text" class="ps-2 form-control border border-secondary-subtle @error('name') is-invalid @enderror" placeholder="Name" aria-label="name" id="name" name="name" value="{{ old('name', $user->name) }}">
                        @error('name')
                      ...
                      <div class="ms-3 me-3 text-end">
                          ...
                          <button type="submit" class="btn bg-gradient-success ws-15 my-4 mb-2">Update</button>
                      </div>
                  </form>
                </div>
              </div>
