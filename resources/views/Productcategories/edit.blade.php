...
@section('title',  isset($setting) ? $setting->app_name : ' - Edit Product Categories' ?? 'Edit Product Categories')
@section('sidebar')
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <div class="card border-1 m-3 pt-3">
                                <form action="{{ route('productcategories.update', $productcat->id) }}" method="POST"
                                    ...
                                    <div class="mb-3 ms-3 me-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="category_name"
                                            value="{{ old('category_name', $productcat->category_name) }}">
                                        @error('category_name')
                                    ...
                                    <div class="mb-3 ms-3 me-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('cycle', $productcat->cycle) }}">
                                        @error('cycle')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
